...
// Fallback content — used until releases are added in the Sanity Studio.
const fallbackReleases: ReleaseItem[] = [
  { id: 1, title: "Release Title", releaseType: "Single", year: "2025" },
  { id: 2, title: "Release Title", releaseType: "EP", year: "2024" },
  { id: 3, title: "Release Title", releaseType: "Remix", year: "2024" },
];
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {items.map((release, index) => (
              ...
              >
                <div className="relative aspect-square rounded-[1.5rem] bg-white/[0.04] border border-white/5 flex items-center justify-center overflow-hidden">
                  {release.coverUrl ? (
                    <Image
